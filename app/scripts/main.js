...
$('#nav-episode6').on('click', function () {
      $('#episodes').scrollTo($('#episode6'), 500);
      return false;
  });

$('#nav-episode7').on('click', function () {
      $('#episodes').scrollTo($('#episode7'), 500);
      return false;
  });

$('#nav-episode8').on('click', function () {
      $('#episodes').scrollTo($('#episode8'), 500);
      return false;
  });

$('#nav-episode9').on('click', function () {
      $('#episodes').scrollTo($('#episode9'), 500);
      return false;
  });

$('#nav-episode10').on('click', function () {
      $('#episodes').scrollTo($('#episode10'), 500);
      return false;
  });

$('#nav-2episode1').on('click', function () {
      $('#episodes').scrollTo($('#s2-episode1'), 500);
      return false;
  });

$('#nav-2episode2').on('click', function () {
      $('#episodes').scrollTo($('#s2-episode2'), 500);
      return false;
  });

$('#nav-2episode3').on('click', function () {
      $('#episodes').scrollTo($('#s2-episode3'), 500);
      return false;
  });
